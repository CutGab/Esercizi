...
for i in target:
    ...
    while True:
        ...
        #1e-5 è una notazione usata per rappresentare 0.00001 (sarebbe 1 * 10^-5), in pratica quando nota che che la differenza tra il valore corrente di p e il nostro target è inferiore a 0.00001 il ciclo si interrompe
        #abs invece è una funzione che restituisce un numero sempre positivo quindi permette di approssimare sena preoccuparsi che la differenza sia negativa o positiva
        if abs(pi - i) < 1e-5:
            break
